...
public class PagingInterceptor implements Interceptor {
  ...
  //用户提供分页计算条数后缀
    static final String suffix = "ByPage";
    ...
    */
    protected synchronized void initStatementMap(Configuration configuration) {
        ...
        for (Iterator<String> iter = statements.iterator(); iter.hasNext();) {
            ...
            System.err.println("-----   sql   -----"+element);
...
//        page.setRecords(data);
        page.setTotle(getTotalSize(invocation, configuration, mappedStatement, boundSql, parameter));
    ...
    */
    ...
    protected int getTotalSize(Invocation invocation, Configuration configuration, MappedStatement mappedStatement,
        ...
        //TODO 待删除
        System.err.println("-----  getTotalSize  -----"+count_id);
        int totalSize = 0;
    ...
    */
    protected String getLimitString(String sql, Page page) {
        ...
        sb.append(sql);
//        sb.append(" limit ").append(page.getPageSize()*page.getIndex() - 1).append(",").append(page.getPageSize());
        int index = page.getPageSize()*page.getIndex() - 1;
        if (index < 0) {
        	index = 0;
		}
        sb.append(" limit ").append(index).append(",").append(page.getPageSize());
        return sb.toString();
    }
